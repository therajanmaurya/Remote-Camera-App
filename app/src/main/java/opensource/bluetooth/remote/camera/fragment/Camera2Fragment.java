...
public class Camera2Fragment extends android.support.v4.app.Fragment
        ...
        private void process(CaptureResult result) {
            switch (mState) {
                case STATE_PREVIEW: {
                    ...
                    Log.d(TAG, "Preview Camera Resultr");
                    break;
                }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.fb_camera).setOnClickListener(this);
    ...
    /**
     * Opens the camera specified by {@link Camera2ServerFragment#mCameraId}.
     */
